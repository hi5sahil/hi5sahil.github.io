...
pwd gives you the address of your current directory
It is used without an argument
pwd

ls shows everything that is in a directory
ls  DIRECTORY
If you run ls without an argument ...
it shows what is in the current directory
cd (change directory)
